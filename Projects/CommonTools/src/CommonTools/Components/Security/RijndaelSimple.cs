...
namespace CommonTools.Components.Security
{
    ...
    public static class RijndaelSimple
    {
        ...
        {
            return Encrypt(pPlainText, pPassPhrase, pSaltValue, "SHA1", 2, pInitVector, 256);
        }
        ...
        /// <param name="pInitVector"></param>
        /// <returns></returns>
        /// <seealso cref="RijndaelSimple.Encrypt(string, string, string, string)"/>
        ...
        {
            return Decrypt(pCipherText, pPassPhrase, pSaltValue, "SHA1", 2, pInitVector, 256);
        }
    }
}
