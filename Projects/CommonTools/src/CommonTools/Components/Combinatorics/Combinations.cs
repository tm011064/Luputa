...
namespace CommonTools.Components.Combinatorics
{
    class t
    {
        ...
        public void test()
        {
            Combinations<char> comb = new Combinations<char>(new List<char>() { 'A', 'B', 'C', 'D', 'E' }, 4);
            foreach (var r in comb)
                System.Diagnostics.Trace.WriteLine("/// " + ConversionHelper.GetDebugString((List<char>)r, ""));
        }
    }
    /// <summary>
