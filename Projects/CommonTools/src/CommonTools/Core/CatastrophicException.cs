...
namespace CommonTools.Core
{
    ...
    /// 
    /// </summary>
    public class CatastrophicException : System.Exception
    {
        /// <summary>
        ...
        public CatastrophicException(Exception innerException, bool isLogged)
        ...
        /// <param name="isLogged">if set to <c>true</c> [is logged].</param>
        public CatastrophicException(string message, bool isLogged)
            : base(message)
        {
            this.IsLogged = IsLogged;
        }
        ...
        /// <param name="innerException">The inner exception.</param>
        /// <param name="isLogged">if set to <c>true</c> [is logged].</param>
        public CatastrophicException(string message, Exception innerException, bool isLogged)
